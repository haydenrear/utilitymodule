...
public class SpecialMethodToolCallbackProvider implements ToolCallbackProvider {
    ...
    public  SpecialMethodToolCallbackProvider(List<Object> toolObjects, SpecialJsonSchemaGenerator specialJsonSchemaGenerator, DelegatingSchemaReplacer schemaReplacer) {
