...
public class ResultTestModel {
    ...
    public record TestAgg(Set<ErrorCollect> errors) implements AggregateError.StdAggregateError {
    }
    ...
    public record TestOneErr(String getMessage) implements ErrorCollect {
    }
    ...
    public record TestErr(String getMessage) implements ErrorCollect {
    }
